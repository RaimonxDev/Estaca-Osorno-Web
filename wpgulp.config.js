...
module.exports = {
	// https://localhost:3000/estacaOsorno/wp-admin/
	// Project options.
	projectURL: 'https://localhost/estacaOsorno/wp-admin/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: true,
	injectChanges: true,

	// Style options.
	styleSRC: './src/scss/main.scss', // Path to main .scss file.
	...
	// Translation options.
	textDomain: 'estacaOsorno', // Your textdomain here.
	...
	team: 'Ramon Martinez <ramonmartinezcordero@gmail.com>', // Team's Email ID.
